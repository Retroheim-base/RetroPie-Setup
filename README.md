...
This script is designed for use on Ubuntu, any other system is unadvised since we (RetroHeim) are not going to be making sure that systems using an OS other than Ubuntu will work.
